...
'''
def make_packet(pulses): 
    header = "1110" * 4 # The beginning of the packet
    payload = int(pulses/2) * "10" 

    return header + payload

'''
Forward right: 20 - 36 - undocumented!
Forward right: 32 - 48
NOTHING????? 44 - 60
Left Backward - Right Forward: 56 - 72
Both Forward: 68 - 84
Back Right: 80 - 96 
Left Forward - Right Back: 92 - 108 
Both Backwards: 104 - 120 
Back Left: 116 - 132
Left Forward: 128 - 144
'''
def forward_right(amount):
    return amount * make_packet(32)

def forward_left(amount):
    return amount * make_packet(128)

def forward_both(amount):
    return amount * make_packet(68)

def back_right(amount):
    return amount * make_packet(80)

def back_left(amount):
    return amount * make_packet(116)

def back_both(amount):
    return amount * make_packet(104)   

def lforward_rback(amount):
    return amount * make_packet(92)
